        ...
        <div class='row'>
            ...
            <div class='col-md-9'>
                ...
                <div id="category" class="category-carousel hidden-xs">
                    <div class="item">
                        <div class="image"> <img src="frontend/assets/images/banners/cat-banner-1.jpg" alt="" class="img-responsive">
                        </div>
                                            ...
                                            <div class="row product-list-row">
                                                ...
                                                <div class="col col-sm-8 col-lg-8">
                                                    <div class="product-info">
                                                        ...
                                                        <!-- /.product-price -->
                                                        <div class="description m-t-10">{{ strip_tags($product->short_descp) }}</div>
                                                        <div class="cart clearfix animate-effect">
                                                            <div class="action">
                                                                <ul class="list-unstyled">
                                                                    <li class="add-cart-button btn-group">
