                ...
                <div class="sidebar-module-container">
                    ...
                    <div class="sidebar-widget  wow fadeInUp outer-top-vs ">
                        <div id="advertisement" class="advertisement">
                            <div class="item">
                                <div class="avatar"><img src="frontend/assets/images/testimonials/member1.png" alt="Image">
                                </div>
                            ...
                            <div class="item">
                                <div class="avatar"><img src="frontend/assets/images/testimonials/member3.png" alt="Image">
                                </div>
                                <div class="testimonials"><em>"</em>Vtae sodales aliq uam morbi non sem lacus port
                                    mollis. Nunc condime tum metus eud molest sed consectetuer.<em>"</em></div>
                            ...
                            <div class="item">
                                <div class="avatar"><img src="frontend/assets/images/testimonials/member2.png" alt="Image">
                                </div>
                                <div class="testimonials"><em>"</em> Vtae sodales aliq uam morbi non sem lacus port
                                    mollis. Nunc condime tum metus eud molest sed consectetuer.<em>"</em></div>
                            ...
                            <div class="product-item-holder size-big single-product-gallery small-gallery">
                                ...
                                <div id="owl-single-product">
                                    ...
                                    <div class="single-product-gallery-item" id="slide{{ $image->id }}">
                                        <a data-lightbox="image-1" data-title="Gallery" href="{{ $image->photo_name }}">
                                            <img class="img-responsive" alt="" src="{{ $image->photo_name }}" data-echo="{{ $image->photo_name }}" />
                                        </a>
                                    ...
                                    <div id="owl-single-product-thumbnails">
                                        ...
                                        <div class="item">
                                            <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="1">
                                                <img class="img-responsive" width="85" alt="" src="{{ $image->photo_name }}" data-echo="{{ $image->photo_name }}" />
                                            </a>
                                        </div>
                                        @endforeach
                        ...
                        <div class='col-sm-6 col-md-7 product-info-block'>
                            <div class="product-info">
                                ...
                                <div class="description-container m-t-20">
                                    {{ strip_tags($product->short_descp) }}
                                ...
                                <div class="quantity-container info-container">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <button type="submit" onclick="addToCart()" class="btn btn-primary mb-2">
