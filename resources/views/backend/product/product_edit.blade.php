                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select name="subsubcategory_id" class="form-control" required>
                                                        ...
                                                        <option value="{{ $item->id }}" {{ $item->id == $product->subsubcategory_id ? 'selected' : '' }}>{{ $item->subsubcategory_name }}</option>
                                                        @endforeach
                                                    </select>
                                    ...
                                    <div class="row"> <!-- start 3st row -->
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_tags" class="form-control" value="{{ $product->product_tags }}" data-role="tagsinput" required>
                                                    @error('product_tags')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_size" class="form-control" value="{{ $product->product_size}}" data-role="tagsinput" required>
                                                    @error('product_size')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_color" class="form-control" value="{{ $product->product_color }}" data-role="tagsinput" required>
                                                    @error('product_color')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
            ...
            <div class="box bt-3 border-info">
                ...
                <form action="{{ route('update-product-image') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row row-sm">
                        ...
                        <div class="col-md-3">
                            <div class="card">
                                <img src="{{ $img->photo_name }}" class="card-img-top" style="height: 130px; width: 280px;">
                                <div class="card-body">
                                    <h5 class="card-title">
            ...
            <div class="box bt-3 border-info">
                ...
                <form action="{{ route('update-product-thambnail') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row row-sm">
                        <div class="col-md-3">
                            <div class="card">
                                <img src="{{ $product->product_thambnail }}" class="card-img-top" style="height: 130px; width: 280px;">
                                <div class="card-body">
                                    <p class="card-text">
                                    <div class="form-group">
                                        <label class="form-control-label">Change Image <span class="tx-danger">*</span></label>
